      ...
      <main className="flex-1">
        <div className="container py-12 mx-auto">
          ...
          <div className="text-center space-y-4 mb-12">
            <h1 className="font-heading text-4xl font-bold">Community Newsletter</h1>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Stay connected with our FFWPU Philippines family through weekly inspiration, community updates, and
              spiritual guidance from True Parents' teachings.
            </p>
          </div>

          {/* Newsletter Signup Hero */}
          <div className="mb-16">
            <EnhancedNewsletterSignup variant="hero" className="max-w-md mx-auto" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Weekly inspirations sent</p>
              </CardContent>
            </Card>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">Most recent newsletter</p>
              </CardContent>
            </Card>
          </div>
          ...
          <section className="space-y-8">
            <div className="text-center space-y-4">
              <h2 className="font-heading text-3xl font-bold">Newsletter Archive</h2>
              <p className="text-muted-foreground max-w-2xl mx-auto">
                Browse our collection of past newsletters filled with inspiration, community news, and spiritual
                insights.
              </p>
            </div>
            ...
            {newsletters.length > 0 ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground mb-6">
                  We're preparing our first newsletter. Subscribe to be notified when it's ready!
                </p>
