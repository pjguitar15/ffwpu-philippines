...
export const metadata: Metadata = {
  title: "FFWPU Philippines - Family Federation for World Peace and Unification",
  description:
  ...
  twitter: {
    ...
    title: "FFWPU Philippines - Building World Peace and Unity",
    description: "Join us in creating a world of peace, love, and unity through True Parents' teachings.",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className={`${montserrat.variable} ${inter.variable} antialiased scrollbar-thin`}>
      <head>
      ...
      <body className="font-body page-transition">{children}</body>
    </html>
  )
}
