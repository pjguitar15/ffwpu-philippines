      ...
      <main className="flex-1">
        <div className="container py-12">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-heading">Information We Collect</CardTitle>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-heading">How We Use Your Information</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-heading">Information Sharing</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-muted-foreground">
                  We do not sell, trade, or otherwise transfer your personal information to third parties without your
                  consent, except as described in this policy. We may share information with trusted service providers
                  who assist us in operating our website and conducting our mission.
                </p>
              </CardContent>
            </Card>
