...
export function HeroSection() {
  return (
    ...
    >
      ...
      {/* Content */}
      <div className='container mx-auto px-4 md:px-6 grid place-items-center md:py-16'>
        <div className='relative z-10 mx-auto max-w-5xl text-center space-y-7 py-[7rem]'>
          {/* Eyebrow */}
