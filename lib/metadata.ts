...
export const pageMetadataConfigs = {
  home: {
    title: 'Home',
    description: 'Welcome to FFWPU Philippines. Join us in building a world of peace, love, and unity through the teachings of True Parents - Rev. Sun Myung Moon and Hak Ja Han Moon.',
  ...
  contact: {
    ...
    keywords: ['contact', 'address', 'phone', 'email', 'location', 'get in touch'],
    canonical: '/contact',
    breadcrumbs: [
      { name: 'Home', url: '/' },
  ...
  hjMediaWorks: {
    ...
    keywords: ['HJ Media Works', 'True Mother', 'Hak Ja Han Moon', 'media', 'videos', 'content'],
    section: 'media',
  ...
  holyMotherHan: {
    ...
    description: 'Learn about Holy Mother Han (Hak Ja Han Moon), True Mother and co-founder of the Family Federation for World Peace and Unification.',
    keywords: ['Holy Mother Han', 'Hak Ja Han Moon', 'True Mother', 'biography'],
    canonical: '/holy-mother-han',
  },
  trueFather: {
    title: 'True Father',
    description: 'Learn about True Father Rev. Sun Myung Moon, founder of the Family Federation for World Peace and Unification.',
    keywords: ['True Father', 'Rev. Sun Myung Moon', 'founder', 'biography'],
    canonical: '/true-father',
  },
  messages: {
    title: 'Messages',
    description: 'Read important messages and guidance from our church leadership and True Parents.',
